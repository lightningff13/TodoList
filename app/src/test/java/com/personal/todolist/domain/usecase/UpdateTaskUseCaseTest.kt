...
class UpdateTaskUseCaseTest(
    ...
    private val updateTaskDescriptionUseCase = UpdateTaskDescriptionUseCase(todoListRepository)
    private val updateTaskCompletionUseCase = UpdateTaskCompletionUseCase(todoListRepository)
